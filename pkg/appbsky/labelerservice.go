...
func init() {
	glexrt.RegisterType("app.bsky.labeler.service", &LabelerService{})
}
...
type LabelerService struct {
	...
	Labels        *LabelerService_Labels      `json:"labels,omitempty"`
...
func (t *LabelerService) MarshalCBOR(w io.Writer) error {
	...
	t.LexiconTypeID = "app.bsky.labeler.service"
	return glexrt.MarshalCBOR(w, t)
}

func (t *LabelerService) UnmarshalCBOR(r io.Reader) error {
