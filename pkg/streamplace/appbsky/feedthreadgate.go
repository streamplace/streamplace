...
type FeedThreadgate_FollowerRule struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.threadgate#followerRule,omitempty"`
}
...
type FeedThreadgate_FollowingRule struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.threadgate#followingRule,omitempty"`
}
...
type FeedThreadgate_ListRule struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.threadgate#listRule,omitempty"`
...
type FeedThreadgate_MentionRule struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.threadgate#mentionRule,omitempty"`
}
