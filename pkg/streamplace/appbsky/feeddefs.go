...
type FeedDefs_BlockedAuthor struct {
	LexiconTypeID string                 `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#blockedAuthor,omitempty"`
...
type FeedDefs_BlockedPost struct {
	LexiconTypeID string                 `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#blockedPost,omitempty"`
...
type FeedDefs_FeedViewPost struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#feedViewPost,omitempty"`
...
type FeedDefs_GeneratorView struct {
	LexiconTypeID       string                         `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#generatorView,omitempty"`
...
type FeedDefs_GeneratorViewerState struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#generatorViewerState,omitempty"`
...
type FeedDefs_Interaction struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#interaction,omitempty"`
...
type FeedDefs_NotFoundPost struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#notFoundPost,omitempty"`
...
type FeedDefs_PostView struct {
	LexiconTypeID string                     `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#postView,omitempty"`
...
type FeedDefs_ReasonPin struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#reasonPin,omitempty"`
}

// FeedDefs_ReasonRepost is a "reasonRepost" in the app.bsky.feed.defs schema.
type FeedDefs_ReasonRepost struct {
	LexiconTypeID string                     `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#reasonRepost,omitempty"`
...
type FeedDefs_ReplyRef struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#replyRef,omitempty"`
...
type FeedDefs_SkeletonFeedPost struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#skeletonFeedPost,omitempty"`
...
type FeedDefs_SkeletonReasonPin struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#skeletonReasonPin,omitempty"`
}
...
type FeedDefs_SkeletonReasonRepost struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#skeletonReasonRepost,omitempty"`
...
type FeedDefs_ThreadContext struct {
	LexiconTypeID  string  `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#threadContext,omitempty"`
...
type FeedDefs_ThreadViewPost struct {
	LexiconTypeID string                                 `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#threadViewPost,omitempty"`
...
type FeedDefs_ThreadgateView struct {
	LexiconTypeID string                    `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#threadgateView,omitempty"`
	Cid           *string                   `json:"cid,omitempty" cborgen:"cid,omitempty"`
	Lists         []GraphDefs_ListViewBasic `json:"lists,omitempty" cborgen:"lists,omitempty"`
	Record        map[string]any            `json:"record,omitempty" cborgen:"record,omitempty"`
	Uri           *string                   `json:"uri,omitempty" cborgen:"uri,omitempty"`
}
...
type FeedDefs_ViewerState struct {
	LexiconTypeID     string  `json:"$type,omitempty" cborgen:"$type,const=app.bsky.feed.defs#viewerState,omitempty"`
