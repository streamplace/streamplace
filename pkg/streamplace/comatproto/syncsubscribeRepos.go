...
type SyncSubscribeRepos_Account struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=com.atproto.sync.subscribeRepos#account,omitempty"`
...
type SyncSubscribeRepos_Commit struct {
	LexiconTypeID string            `json:"$type,omitempty" cborgen:"$type,const=com.atproto.sync.subscribeRepos#commit,omitempty"`
...
type SyncSubscribeRepos_Identity struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=com.atproto.sync.subscribeRepos#identity,omitempty"`
	Did           string `json:"did" cborgen:"did"`
...
type SyncSubscribeRepos_Info struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=com.atproto.sync.subscribeRepos#info,omitempty"`
...
type SyncSubscribeRepos_RepoOp struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=com.atproto.sync.subscribeRepos#repoOp,omitempty"`
...
type SyncSubscribeRepos_Sync struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=com.atproto.sync.subscribeRepos#sync,omitempty"`
