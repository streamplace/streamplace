...
func init() {
	lexutil.RegisterType("place.stream.richtext.videoFacet#main", &RichtextVideoFacet{})
}

// Annotation of a sub-string within rich text in a VOD description or comment.
type RichtextVideoFacet struct {
	LexiconTypeID string                              `json:"$type,omitempty" cborgen:"$type,const=place.stream.richtext.videoFacet,omitempty"`
	Features      []*RichtextVideoFacet_Features_Elem `json:"features" cborgen:"features"`
