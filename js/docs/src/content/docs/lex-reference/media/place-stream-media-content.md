---
title: place.stream.media.content
description: Reference for the place.stream.media.content lexicon
---
...
Some media content: potentially video, audio, or subtitles. This record is intentionally minimal so that metadata can be altered without breaking strongRefs. For the stream's title and description and whatnot, check the `place.stream.video` with the tid matching this video.
...
{
  "lexicon": 1,
  "id": "place.stream.media.content",
  "defs": {
    "main": {
      "type": "record",
      "description": "Some media content: potentially video, audio, or subtitles. This record is intentionally minimal so that metadata can be altered without breaking strongRefs. For the stream's title and description and whatnot, check the `place.stream.video` with the tid matching this video.",
      "key": "tid",
      "record": {
        "type": "object",
