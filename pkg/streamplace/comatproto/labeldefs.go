...
type LabelDefs_Label struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=com.atproto.label.defs#label,omitempty"`
...
type LabelDefs_LabelValueDefinition struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=com.atproto.label.defs#labelValueDefinition,omitempty"`
...
type LabelDefs_LabelValueDefinitionStrings struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=com.atproto.label.defs#labelValueDefinitionStrings,omitempty"`
...
type LabelDefs_SelfLabel struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=com.atproto.label.defs#selfLabel,omitempty"`
	// val: The short string name of the value or type of this label.
	Val string `json:"val" cborgen:"val"`
}
...
type LabelDefs_SelfLabels struct {
	LexiconTypeID string                `json:"$type,omitempty" cborgen:"$type,const=com.atproto.label.defs#selfLabels,omitempty"`
