...
# Usage: hack/broadcasttime.sh URL TEXT
# Url is rtmp://oregon.ingress.stream.kitchen:1934/stream/[this part here]
...
drawName="drawtext=fontfile=$(pwd)/font.ttf: text='$2': fontcolor=white@1: fontsize=50: x=300: y=400: box=1: boxcolor=black"
...
ffmpeg \
  ...
  "\
  -map '[output]' \
  "rtmp://oregon.ingress.stream.kitchen:1934/stream/$1"
