...
type ModerationCreateReport_ModTool struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=com.atproto.moderation.createReport#modTool,omitempty"`
	// meta: Additional arbitrary metadata about the source
	Meta map[string]any `json:"meta,omitempty" cborgen:"meta,omitempty"`
