...
type NotificationDefs_ActivitySubscription struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.notification.defs#activitySubscription,omitempty"`
...
type NotificationDefs_ChatPreference struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.notification.defs#chatPreference,omitempty"`
...
type NotificationDefs_FilterablePreference struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.notification.defs#filterablePreference,omitempty"`
	Include       string `json:"include" cborgen:"include"`
...
type NotificationDefs_Preference struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.notification.defs#preference,omitempty"`
	List          bool   `json:"list" cborgen:"list"`
	Push          bool   `json:"push" cborgen:"push"`
}
...
type NotificationDefs_Preferences struct {
	LexiconTypeID     string                                `json:"$type,omitempty" cborgen:"$type,const=app.bsky.notification.defs#preferences,omitempty"`
...
type NotificationDefs_RecordDeleted struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.notification.defs#recordDeleted,omitempty"`
}
...
type NotificationDefs_SubjectActivitySubscription struct {
	LexiconTypeID        string                                `json:"$type,omitempty" cborgen:"$type,const=app.bsky.notification.defs#subjectActivitySubscription,omitempty"`
