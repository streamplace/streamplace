...
type AdminDefs_AccountView struct {
	LexiconTypeID    string                      `json:"$type,omitempty" cborgen:"$type,const=com.atproto.admin.defs#accountView,omitempty"`
	...
	RelatedRecords   []map[string]any            `json:"relatedRecords,omitempty" cborgen:"relatedRecords,omitempty"`
...
type AdminDefs_RepoBlobRef struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=com.atproto.admin.defs#repoBlobRef,omitempty"`
...
type AdminDefs_RepoRef struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=com.atproto.admin.defs#repoRef,omitempty"`
	Did           string `json:"did" cborgen:"did"`
}

// AdminDefs_StatusAttr is a "statusAttr" in the com.atproto.admin.defs schema.
type AdminDefs_StatusAttr struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=com.atproto.admin.defs#statusAttr,omitempty"`
...
type AdminDefs_ThreatSignature struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=com.atproto.admin.defs#threatSignature,omitempty"`
