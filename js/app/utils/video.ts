...
// VOD thumbnails are stored as blobs on the author's PDS and served through
// the Bluesky image CDN — the same trick the OG link cards and game cover art
...
// Format a millisecond duration as a compact runtime badge, e.g. 9:05 or
// 1:09:05. Returns undefined for missing/zero durations.
