...
func (t *SyncListRepos_Output) MarshalCBOR(w io.Writer) error {
	...
	t.LexiconTypeID = "com.atproto.sync.listRepos#main"
...
func SyncListRepos(ctx context.Context, c glexrt.LexClient, cursor string, limit *int64) (*SyncListRepos_Output, error) {
	...
	if err := c.LexDo(ctx, glexrt.Query, "", "com.atproto.sync.listRepos", params, nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
