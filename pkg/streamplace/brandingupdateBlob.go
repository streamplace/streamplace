...
// schema: place.stream.branding.updateBlob
...
func BrandingUpdateBlob(ctx context.Context, c util.LexClient, input *BrandingUpdateBlob_Input) (*BrandingUpdateBlob_Output, error) {
	var out BrandingUpdateBlob_Output
	if err := c.LexDo(ctx, util.Procedure, "application/json", "place.stream.branding.updateBlob", nil, input, &out); err != nil {
		return nil, err
	}
