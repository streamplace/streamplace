...
branding-theme-description = The app derives its surfaces, text and borders from one background and one foreground color per color scheme. Hex colors (#rrggbb). Leave a value unset to use the default.
branding-background-dark = Background (dark)
branding-foreground-dark = Foreground (dark)
