...
type EmbedRecord struct {
	LexiconTypeID string                   `json:"$type,omitempty" cborgen:"$type,const=app.bsky.embed.record,omitempty"`
...
type EmbedRecord_View struct {
	LexiconTypeID string                  `json:"$type,omitempty" cborgen:"$type,const=app.bsky.embed.record#view,omitempty"`
...
type EmbedRecord_ViewBlocked struct {
	LexiconTypeID string                 `json:"$type,omitempty" cborgen:"$type,const=app.bsky.embed.record#viewBlocked,omitempty"`
...
type EmbedRecord_ViewDetached struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.embed.record#viewDetached,omitempty"`
...
type EmbedRecord_ViewNotFound struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.embed.record#viewNotFound,omitempty"`
...
type EmbedRecord_ViewRecord struct {
	LexiconTypeID string                               `json:"$type,omitempty" cborgen:"$type,const=app.bsky.embed.record#viewRecord,omitempty"`
