...
type Defs_ActorCreditView struct {
	LexiconTypeID string              `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#actorCreditView,omitempty"`
...
type Defs_ActorProfileDetailView struct {
	LexiconTypeID     string                   `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#actorProfileDetailView,omitempty"`
...
type Defs_AgeRating struct {
	LexiconTypeID      string   `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#ageRating,omitempty"`
...
type Defs_AlternativeName struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#alternativeName,omitempty"`
...
type Defs_CollectionSummaryView struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#collectionSummaryView,omitempty"`
	Name          string  `json:"name" cborgen:"name"`
...
type Defs_CreditEntry struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#creditEntry,omitempty"`
...
type Defs_EngineSummaryView struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#engineSummaryView,omitempty"`
	Name          string  `json:"name" cborgen:"name"`
	Slug          *string `json:"slug,omitempty" cborgen:"slug,omitempty"`
	Uri           string  `json:"uri" cborgen:"uri"`
}
...
type Defs_ExternalIds struct {
	LexiconTypeID string         `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#externalIds,omitempty"`
...
type Defs_ExternalVideo struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#externalVideo,omitempty"`
...
type Defs_GameDetailView struct {
	LexiconTypeID      string                  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#gameDetailView,omitempty"`
...
type Defs_GameFeedViewItem struct {
	LexiconTypeID string         `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#gameFeedViewItem,omitempty"`
...
type Defs_GameSummaryView struct {
	LexiconTypeID   string  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#gameSummaryView,omitempty"`
	ApplicationType *string `json:"applicationType,omitempty" cborgen:"applicationType,omitempty"`
...
type Defs_GameView struct {
	LexiconTypeID   string            `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#gameView,omitempty"`
...
type Defs_ItchIoId struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#itchIoId,omitempty"`
...
type Defs_LanguageSupport struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#languageSupport,omitempty"`
...
type Defs_MediaItem struct {
	LexiconTypeID string    `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#mediaItem,omitempty"`
...
type Defs_MultiplayerMode struct {
	LexiconTypeID        string  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#multiplayerMode,omitempty"`
...
type Defs_OrgCreditView struct {
	LexiconTypeID string    `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#orgCreditView,omitempty"`
	DisplayName   *string   `json:"displayName,omitempty" cborgen:"displayName,omitempty"`
...
type Defs_OrgProfileDetailView struct {
	LexiconTypeID     string                   `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#orgProfileDetailView,omitempty"`
	Avatar            *lex.Blob                `json:"avatar,omitempty" cborgen:"avatar,omitempty"`
...
type Defs_OrgProfileSummaryView struct {
	LexiconTypeID string    `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#orgProfileSummaryView,omitempty"`
	Avatar        *lex.Blob `json:"avatar,omitempty" cborgen:"avatar,omitempty"`
	Did           string    `json:"did" cborgen:"did"`
	DisplayName   *string   `json:"displayName,omitempty" cborgen:"displayName,omitempty"`
	Uri           string    `json:"uri" cborgen:"uri"`
...
type Defs_PlatformFeatures struct {
	LexiconTypeID string   `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#platformFeatures,omitempty"`
...
type Defs_PlatformSummaryView struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#platformSummaryView,omitempty"`
...
type Defs_PlatformVersion struct {
	LexiconTypeID string            `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#platformVersion,omitempty"`
...
type Defs_ProfileSummaryView struct {
	LexiconTypeID string    `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#profileSummaryView,omitempty"`
	Avatar        *lex.Blob `json:"avatar,omitempty" cborgen:"avatar,omitempty"`
	Did           string    `json:"did" cborgen:"did"`
	DisplayName   *string   `json:"displayName,omitempty" cborgen:"displayName,omitempty"`
...
type Defs_Release struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#release,omitempty"`
...
type Defs_ReleaseDate struct {
	LexiconTypeID    string  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#releaseDate,omitempty"`
...
type Defs_Signature struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#signature,omitempty"`
	// key: DID key reference (e.g., did:web:example.com#signing1).
	Key string `json:"key" cborgen:"key"`
	// signature: The signature bytes.
	Signature lex.Bytes `json:"signature,omitempty" cborgen:"signature,omitempty"`
}
...
type Defs_SkeletonGameFeedItem struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#skeletonGameFeedItem,omitempty"`
	FeedContext   *string `json:"feedContext,omitempty" cborgen:"feedContext,omitempty"`
	Game          string  `json:"game" cborgen:"game"`
}
...
type Defs_SystemRequirements struct {
	LexiconTypeID string           `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#systemRequirements,omitempty"`
...
type Defs_SystemSpec struct {
	LexiconTypeID   string  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#systemSpec,omitempty"`
...
type Defs_TimeToBeat struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#timeToBeat,omitempty"`
...
type Defs_ViewerState struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#viewerState,omitempty"`
...
type Defs_Website struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=games.gamesgamesgamesgames.defs#website,omitempty"`
	Type          *string `json:"type,omitempty" cborgen:"type,omitempty"`
