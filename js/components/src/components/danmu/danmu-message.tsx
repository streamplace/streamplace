...
export const DanmuMessage = memo(
  ({
    ...
    const getRgbColor = (
      ...
      return `rgb(${Math.round(red)}, ${Math.round(green)}, ${Math.round(blue)})`; // eslint-disable-line streamplace/no-token-literals -- dynamic user color / soft shadow
    };
...
const styles = StyleSheet.create({
  ...
  text: {
    ...
    textShadowColor: "rgba(0, 0, 0, 0.8)", // eslint-disable-line streamplace/no-token-literals
