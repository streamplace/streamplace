...
func (t *BadgeDisplay) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("place.stream.badge.display"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("place.stream.badge.display")); err != nil {
		return err
	}

	// t.Badges ([]*streamplace.BadgeDisplay_BadgeSelection) (slice)
	...
	if len(t.Badges) > 8192 {
		return xerrors.Errorf("Slice value in field t.Badges was too long")
	}

	if err := cw.WriteMajorTypeHeader(cbg.MajArray, uint64(len(t.Badges))); err != nil {
		return err
	}
	for _, v := range t.Badges {
		if err := v.MarshalCBOR(cw); err != nil {
			return err
		}
...
func (t *BadgeDisplay) UnmarshalCBOR(r io.Reader) (err error) {
	*t = BadgeDisplay{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("BadgeDisplay: map struct too large (%d)", extra)
	}
	...
	for i := uint64(0); i < n; i++ {
		...
		case "badges":
			...
			if extra > 8192 {
				return fmt.Errorf("t.Badges: array too large (%d)", extra)
			}
			...
			if extra > 0 {
				t.Badges = make([]*BadgeDisplay_BadgeSelection, extra)
			}
			...
			for i := 0; i < int(extra); i++ {
				{
...

					{
						...
						if b != cbg.CborNull[0] {
							...
							t.Badges[i] = new(BadgeDisplay_BadgeSelection)
							if err := t.Badges[i].UnmarshalCBOR(cr); err != nil {
								return xerrors.Errorf("unmarshaling t.Badges[i] pointer: %w", err)
							}
						}
...
func (t *BadgeDisplay_BadgeSelection) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	// t.Issuance (string) (string)
	if t.Issuance != nil {

		if len("issuance") > 1000000 {
			return xerrors.Errorf("Value in field \"issuance\" was too long")
		}

		if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("issuance"))); err != nil {
			return err
		}
		if _, err := cw.WriteString(string("issuance")); err != nil {
			return err
		}
		...
		if t.Issuance == nil {
			...
			if len(*t.Issuance) > 1000000 {
				return xerrors.Errorf("Value in field t.Issuance was too long")
			}

			if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len(*t.Issuance))); err != nil {
				return err
			}
			if _, err := cw.WriteString(string(*t.Issuance)); err != nil {
				return err
			}
		}
	}
...
func (t *BadgeDisplay_BadgeSelection) UnmarshalCBOR(r io.Reader) (err error) {
	*t = BadgeDisplay_BadgeSelection{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("BadgeDisplay_BadgeSelection: map struct too large (%d)", extra)
	}
