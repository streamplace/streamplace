...
type EmbedVideo struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.embed.video,omitempty"`
...
type EmbedVideo_Caption struct {
	LexiconTypeID string          `json:"$type,omitempty" cborgen:"$type,const=app.bsky.embed.video#caption,omitempty"`
...
type EmbedVideo_View struct {
	LexiconTypeID string                 `json:"$type,omitempty" cborgen:"$type,const=app.bsky.embed.video#view,omitempty"`
	Alt           *string                `json:"alt,omitempty" cborgen:"alt,omitempty"`
	AspectRatio   *EmbedDefs_AspectRatio `json:"aspectRatio,omitempty" cborgen:"aspectRatio,omitempty"`
