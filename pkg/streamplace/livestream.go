...
type Livestream_LivestreamView struct {
	LexiconTypeID string                              `json:"$type,omitempty" cborgen:"$type,const=place.stream.livestream#livestreamView,omitempty"`
...
type Livestream_NotificationSettings struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=place.stream.livestream#notificationSettings,omitempty"`
...
type Livestream_StreamplaceAnything struct {
	LexiconTypeID string                                     `json:"$type,omitempty" cborgen:"$type,const=place.stream.livestream#streamplaceAnything,omitempty"`
...
type Livestream_TeleportArrival struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=place.stream.livestream#teleportArrival,omitempty"`
...
type Livestream_TeleportCanceled struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=place.stream.livestream#teleportCanceled,omitempty"`
...
type Livestream_ViewerCount struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=place.stream.livestream#viewerCount,omitempty"`
