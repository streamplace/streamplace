...
type GraphDefs_ListItemView struct {
	LexiconTypeID string                `json:"$type,omitempty" cborgen:"$type,const=app.bsky.graph.defs#listItemView,omitempty"`
...
type GraphDefs_ListView struct {
	LexiconTypeID     string                       `json:"$type,omitempty" cborgen:"$type,const=app.bsky.graph.defs#listView,omitempty"`
...
type GraphDefs_ListViewBasic struct {
	LexiconTypeID string                       `json:"$type,omitempty" cborgen:"$type,const=app.bsky.graph.defs#listViewBasic,omitempty"`
	Avatar        *string                      `json:"avatar,omitempty" cborgen:"avatar,omitempty"`
	Cid           string                       `json:"cid" cborgen:"cid"`
...
type GraphDefs_ListViewerState struct {
	LexiconTypeID string  `json:"$type,omitempty" cborgen:"$type,const=app.bsky.graph.defs#listViewerState,omitempty"`
...
type GraphDefs_NotFoundActor struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.graph.defs#notFoundActor,omitempty"`
...
type GraphDefs_Relationship struct {
	LexiconTypeID string `json:"$type,omitempty" cborgen:"$type,const=app.bsky.graph.defs#relationship,omitempty"`
...
type GraphDefs_StarterPackView struct {
	LexiconTypeID      string                       `json:"$type,omitempty" cborgen:"$type,const=app.bsky.graph.defs#starterPackView,omitempty"`
	Cid                string                       `json:"cid" cborgen:"cid"`
...
type GraphDefs_StarterPackViewBasic struct {
	LexiconTypeID      string                       `json:"$type,omitempty" cborgen:"$type,const=app.bsky.graph.defs#starterPackViewBasic,omitempty"`
	Cid                string                       `json:"cid" cborgen:"cid"`
	Creator            ActorDefs_ProfileViewBasic   `json:"creator" cborgen:"creator"`
	IndexedAt          string                       `json:"indexedAt" cborgen:"indexedAt"`
	JoinedAllTimeCount *int64                       `json:"joinedAllTimeCount,omitempty" cborgen:"joinedAllTimeCount,omitempty"`
