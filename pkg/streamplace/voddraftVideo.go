...
func init() {
	lexutil.RegisterType("place.stream.vod.draftVideo", &VodDraftVideo{})
}

type VodDraftVideo struct {
	LexiconTypeID string `json:"$type" cborgen:"$type,const=place.stream.vod.draftVideo"`
	// activity: The game or activity in the video.
	Activity *VodDraftVideo_Activity `json:"activity,omitempty" cborgen:"activity,omitempty"`
	// connections: Related records (e.g. the source livestream for a finalized VOD).
	Connections     []*VodDraftVideo_Connections_Elem `json:"connections,omitempty" cborgen:"connections,omitempty"`
	...
	Source *VodDraftVideo_Source `json:"source,omitempty" cborgen:"source,omitempty"`
