...
// schema: place.stream.richtext.facet
...
type RichtextFacet struct {
	...
	Index    *appbskytypes.RichtextFacet_ByteSlice `json:"index" cborgen:"index"`
}

type RichtextFacet_Features_Elem struct {
	RichtextFacet_Mention *appbskytypes.RichtextFacet_Mention
	RichtextFacet_Link    *appbskytypes.RichtextFacet_Link
}
...
func (t *RichtextFacet_Features_Elem) UnmarshalJSON(b []byte) error {
	...
	case "app.bsky.richtext.facet#mention":
		t.RichtextFacet_Mention = new(appbskytypes.RichtextFacet_Mention)
		return json.Unmarshal(b, t.RichtextFacet_Mention)
	case "app.bsky.richtext.facet#link":
		t.RichtextFacet_Link = new(appbskytypes.RichtextFacet_Link)
