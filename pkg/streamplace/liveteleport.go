...
// schema: place.stream.live.teleport
...
func init() {
	util.RegisterType("place.stream.live.teleport", &LiveTeleport{})
} //
// RECORDTYPE: LiveTeleport
type LiveTeleport struct {
	LexiconTypeID string `json:"$type,const=place.stream.live.teleport" cborgen:"$type,const=place.stream.live.teleport"`
