...
type LiveGetRecommendations_Output struct {
	LexiconTypeID string `json:"$type" cborgen:"$type,const=place.stream.live.getRecommendations#main"`
...
type LiveGetRecommendations_LivestreamRecommendation struct {
	LexiconTypeID string `json:"$type" cborgen:"$type,const=place.stream.live.getRecommendations"`
