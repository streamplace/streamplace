...
type MediaTrack_CommonMetadata struct {
	LexiconTypeID string         `json:"$type,omitempty" cborgen:"$type,const=place.stream.media.track#commonMetadata,omitempty"`
...
type MediaTrack_TrackView struct {
	LexiconTypeID string                              `json:"$type,omitempty" cborgen:"$type,const=place.stream.media.track#trackView,omitempty"`
