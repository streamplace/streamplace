...
func (cli *CLI) NewFlagSet(name string) *flag.FlagSet {
	...
	fs.BoolVar(&cli.UseCertMagic, "use-certmagic", false, "Use CertMagic for automatic HTTPS certificate management. By using this, you agree to the CA's terms of service (default: Let's Encrypt).")
	fs.StringVar(&cli.CertMagicCAURL, "certmagic-ca-url", "", "ACME CA URL for CertMagic (default: Let's Encrypt - production)")
