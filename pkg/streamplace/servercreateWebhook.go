...
func ServerCreateWebhook(ctx context.Context, c lexutil.LexClient, input *ServerCreateWebhook_Input) (*ServerCreateWebhook_Output, error) {
	var out ServerCreateWebhook_Output
	if err := c.LexDo(ctx, lexutil.Procedure, "application/json", "place.stream.server.createWebhook", nil, input, &out); err != nil {
		return nil, err
	}
